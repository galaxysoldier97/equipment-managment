...
@Component
public class EquipmentStateMachineWithoutRecyclingService implements StatusChanger<Status, Event> {
    private final StateMachineFactory<Status, Event> stateMachineFactory;
    private final LocalizedMessageBuilder localizedMessageBuilder;

    public EquipmentStateMachineWithoutRecyclingService(final @Qualifier("equipmentStateMachineWithoutRecycling") StateMachineFactory<Status, Event> stateMachineFactory,
